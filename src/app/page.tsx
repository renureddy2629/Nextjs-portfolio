            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div className="md:col-span-2">
                  <h2 className="text-3xl font-bold mb-6">Hello, I'm <span className="text-blue-600">Renuka</span></h2>
                  ...
                  >
                    ...
                    <motion.a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="px-6 py-3 bg-gray-800 rounded-full font-medium flex items-center gap-2 text-white"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <motion.div variants={experienceItem} className="bg-white bg-opacity-100 rounded-lg p-6">
                  <div className="flex flex-col md:flex-row justify-between mb-4">
                    <div>
                      ...
                      <p className="text-blue-600">Omega Healthcare, India</p>
                    </div>
                    <div className="text-gray-700 font-medium mt-2 md:mt-0">
                      Jun 2019 - Aug 2020
                    </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <p className="text-blue-600 mb-2">Computer Science</p>
                  <p className="text-gray-600">Vignan University - India</p>
                </motion.div>
              </div>
            </motion.section>
          )}
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">DeKalb, IL 60115</p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 text-blue-600 mt-1" viewBox="0 0 20 20" fill="currentColor">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">pasamrenuka986@gmail.com</p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 text-blue-600 mt-1" viewBox="0 0 20 20" fill="currentColor">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">779-302-2692</p>
                      </div>
                    </li>
                  </ul>
                </motion.div>
